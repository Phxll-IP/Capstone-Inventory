...
<div class="account-page">
    ...
    <form method="POST" action="{{ route('custom.verification.verify') }}" class="my-4">
        ...
        <div class="form-group mb-3">
            <label for="emailaddress" class="form-label" style="color: #ffffff">Verification Code</label>
            <input class="form-control" type="text" id="code" name="code" required=""  placeholder="Enter verification code" >
            @error('code')
        ...
        <div class="form-group mb-0 row">
            <div class="col-12">
                <div class="d-grid">
                    <button class="btn btn-primary" type="submit" style="color: #ffffff"> Verify </button>
                </div>
            </div>
        </div>
    </form>
